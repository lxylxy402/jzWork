...
import {Button,Table,Modal,DatePicker,TreeSelect,Divider} from '../../../node_modules/_antd@3.7.3@antd';
...
export default class Partywrite extends Component {
    ...
    chooseDate =(e)=>{
        ...
        this.setState({
            BgnDate:new Date(e),
            CBegDate:moment(e).format('YYYY年MM月')+'党务公开'
        })
    ...
    render() {
        ...
        return (
            <div>
                <Button type="primary" onClick={this.showModal}>新增党务发布</Button>
                <Modal
                    destroyOnClose
                    title={'党务公开'}
