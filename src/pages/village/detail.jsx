...
export default class Detail extends Component {
    ...
    Face = (e)=>{
        ...
        if(e.length>0){
            ...
            let face2 = (v3)=>{
                ...
                arr.push(
                    <div  key={v3.key}>
                        ...
                        {
                            this.state.See == 1 ? (<Button type="primary" onClick={()=>this.Hold(v3.key)}>保存</Button>)
                            :
                            (<div></div>)  
                        }
            ...
            face2(v2)
            arr.push(
                <div  key={vv.key}  className="red">
                     <Divider> {vv.label}</Divider>
                     {
                         face(vv.children)
                     }
                </div> 
            ...
            arr.push(
                <div  key={v4.key}  className="red">
                     <Divider> {v4.label}</Divider>
                     {
                         face(v4.children)
                     }
                </div> 
